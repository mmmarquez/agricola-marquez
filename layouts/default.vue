<template>
  <div class="main--wrapper">
    <transition name="slideDown" >
      <div class="main--border top--border" v-if="tBorder"></div>
    </transition>
    <transition name="slideUp" >
      <div class="main--border bottom--border" v-if="bBorder"></div>
    </transition>
    <transition name="slideLeft" >
      <div class="main--border left--border" v-if="lBorder"></div>
    </transition>
    <transition name="slideRight" >
      <div class="main--border right--border" v-if="rBorder"></div>
    </transition>
    <nuxt/>
    <transition name="fade" >
      <FadeOverlay v-if="overlay"/>
    </transition>
  </div>
</template>
...
.main--wrapper { position: relative; height: 100%; width: 100%; overflow: hidden !important;
  .main--border { background: #00233E; position: absolute; z-index: 99; overflow: hidden !important;
    &.top--border {
      height: 12px; left: 0; right: 0; top: 0;
    }
    &.bottom--border {
      height: 12px; left: 0; right: 0; bottom: 0;

    }
    &.left--border {
      width: 12px; left: 0; bottom: 0; top: 0;

    }
    &.right--border {
      width: 12px; right: 0; bottom: 0; top: 0;
